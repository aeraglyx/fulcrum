...
from .operators.utility import AX_OT_locate_vertex, AX_OT_locate_vertices, AX_OT_cloth_vert_mass, AX_OT_open_script_dir, AX_OT_open_blend_dir
...
from .operators.camera_stuff import AX_OT_dof_setup, AX_OT_isometric_setup, AX_OT_projection_setup, AX_OT_hybrid_subdiv
...
classes = (
	...
	AX_OT_locate_vertex, AX_OT_locate_vertices, AX_OT_cloth_vert_mass, AX_OT_open_script_dir, AX_OT_open_blend_dir,
	
	AX_OT_node_flow, AX_OT_unused_nodes, AX_OT_find_inputs, AX_OT_center_nodes, AX_OT_nodes_to_grid, AX_OT_add_todo_note,
	AX_OT_version_encode, AX_OT_version_decode,
	AX_OT_copy_nodes, AX_OT_paste_nodes,

	AX_OT_render_to_new_slot,
	AX_OT_dof_setup, AX_OT_isometric_setup, AX_OT_projection_setup, AX_OT_hybrid_subdiv,
