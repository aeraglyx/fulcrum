...
class AX_OT_render_in_time(bpy.types.Operator):
	...
	bl_label = "Render in Time (Deprecated)"
	...
	def poll(cls, context):
		...
		correct_engine = engine in cls.COMPAT_ENGINES
		has_camera = bool(context.scene.camera)
		return correct_engine and has_camera  # XXX untested
