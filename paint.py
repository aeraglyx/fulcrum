...
class AX_OT_set_paint_brush(bpy.types.Operator):
    """Set color for vertex paint brush""" # todo check if this is the tooltip

    bl_idname = "ax.set_paint_brush"
...
class AX_OT_set_weight_brush(bpy.types.Operator):
    """Set weight for weight paint brush"""

    bl_idname = "ax.set_weight_brush"
